...
class Packml_Dashboard(Plugin):

    def __init__(self, context):
        super(Packml_Dashboard, self).__init__(context)
        self.setObjectName('Packml_Dashboard')
        ...
        ui_file = os.path.join(rospkg.RosPack().get_path('packml_gui'), 'resource', 'packml_dashboard.ui')
        loadUi(ui_file, self._widget)
        self._widget.setObjectName('Packml_Dashboard')
    ...
    def add_arguments(parser):
        ...
        group = parser.add_argument_group('Options for Packml_Dashboard plugin')
